...
// Employee(Chris,Jeppsen,chrisjeppsen@SpeechGrammarList.com, 21)
...
// const bobby = new Manager('Bobby','Ricky','ricky@bobby.com',21)
// console.log(bobby)
// bobby.makeWidget()
// bobby.hire(bobby)
...
class Machine{
  ...
  makeWidgets(number){
    ...
    this.wear_and_tear_count += number * 1/50
  }
  fixMachine(){
